...
pattern_type_tuples = (
    (flt_const_pattern, formulaparser.NUM_CONST),
    (int_const_pattern, formulaparser.INT_CONST),
    (str_const_pattern, formulaparser.STR_CONST),
#    (range2d_pattern  , formulaparser.RANGE2D),
    (ref2d_r1c1_pattern, formulaparser.REF2D_R1C1),
    (ref2d_pattern    , formulaparser.REF2D),
    (true_pattern     , formulaparser.TRUE_CONST),
    (false_pattern    , formulaparser.FALSE_CONST),
    (if_pattern       , formulaparser.FUNC_IF),
    (choose_pattern   , formulaparser.FUNC_CHOOSE),
    (name_pattern     , formulaparser.NAME),
    (quotename_pattern, formulaparser.QUOTENAME),
    (ne_pattern,        formulaparser.NE),
    (ge_pattern,        formulaparser.GE),
    (le_pattern,        formulaparser.LE),
)
...
single_char_lookup = {
    ...
    '/': formulaparser.DIV,
    ':': formulaparser.COLON,
    ';': formulaparser.SEMICOLON,
    ',': formulaparser.COMMA,
    '(': formulaparser.LP,
    ')': formulaparser.RP,
    '&': formulaparser.CONCAT,
    '%': formulaparser.PERCENT,
    '^': formulaparser.POWER,
    '!': formulaparser.BANG,
    }
