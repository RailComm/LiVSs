...
import struct
from .excel.antlr import ANTLRException
...
class Formula(object):
    ...
    def __init__(self, s):
        try:
            self.__s = s
            lexer = formulalexer.Lexer(s)
            self.__parser = formulaparser.Parser(lexer)
            ...
            # print e
            raise formulaparser.FormulaParseException("can't parse formula " + s)
